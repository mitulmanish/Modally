//
//  ModalViewControllerPresentationController.swift
//  Modally
//
...
public class ModalViewControllerPresentationController: UIPresentationController {
    ...
    public init(portraitHeight: CGFloat,
